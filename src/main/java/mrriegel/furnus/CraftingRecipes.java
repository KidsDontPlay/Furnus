...
public class CraftingRecipes {
	...
	public static void init() {
		GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.furnus), "ibi", "bob", "fbf", 'i',
				Items.iron_ingot, 'b', Blocks.brick_block, 'o', Blocks.furnace, 'f', Blocks.sand);
		GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.pulvus), "ibi", "bob", "fbf", 'i',
				Items.iron_ingot, 'b', Blocks.sandstone, 'o', Blocks.furnace, 'f', Items.flint);
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.upgrade, 1, 0), "cgc", "rir", "crc",
				'c', Items.clay_ball, 'i', Items.iron_ingot, 'g', Items.gold_nugget, 'r',
				Blocks.redstone_block);
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.upgrade, 1, 1), "csc", "gig", "csc",
				'c', Items.clay_ball, 'i', Items.iron_ingot, 'g', Items.gold_ingot, 's',
				Blocks.snow);
		GameRegistry
				.addShapedRecipe(new ItemStack(ModItems.upgrade, 1, 2), "chc", " i ", "cpc", 'c',
						Items.clay_ball, 'i', Items.iron_ingot, 'h', Blocks.hopper, 'p',
						Blocks.piston);
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.upgrade, 1, 3), "chc", "hih", "chc",
				'c', Items.clay_ball, 'i', Items.iron_ingot, 'h', Items.diamond);
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.upgrade, 1, 4), "cgc", "rir", "crc",
				'c', Items.clay_ball, 'i', Items.iron_ingot, 'g', Items.emerald, 'r',
				Blocks.lapis_block);
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.upgrade, 1, 5), "cgc", "rir", "cgc",
