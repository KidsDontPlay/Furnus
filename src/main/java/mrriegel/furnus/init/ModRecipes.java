...
public class ModRecipes {
	...
	public static void init() {
		...
		RecipeHelper.addShapedOreRecipe(new ItemStack(ModBlocks.furnus.getItemBlock()), "ibi", "bfb", "#b#", 'i', "ingotIron", 'b', Blocks.BRICK_BLOCK, 'f', Blocks.FURNACE, '#', new ItemStack(Items.COAL));
		RecipeHelper.addShapedOreRecipe(new ItemStack(ModBlocks.pulvus.getItemBlock()), "ibi", "bfb", "#b#", 'i', "ingotIron", 'b', "sandstone", 'f', Blocks.FURNACE, '#', Items.FLINT);
		...
		RecipeHelper.addShapedOreRecipe(new ItemStack(ModItems.upgrade, 2, 2), " p ", " i ", " h ", 'i', "ingotIron", 'p', Blocks.PISTON, 'h', Blocks.HOPPER);
