...
public class MachineContainer extends Container {
	...
	public void detectAndSendChanges() {
		...
		if (startSlot != tile.getSlots()) {
			...
			player.openGui(Furnus.instance, guiID, tile.getWorldObj(), tile.xCoord, tile.yCoord, tile.zCoord);
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotIndex) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (slotIndex <= tileSlots - 1) {
				...
				boolean canProcess = tile instanceof TileFurnus ? FurnaceRecipes.smelting().getSmeltingResult(itemstack1) != null : tile instanceof TilePulvus ? CrunchHandler.instance().getResult(itemstack1) != null : false;
