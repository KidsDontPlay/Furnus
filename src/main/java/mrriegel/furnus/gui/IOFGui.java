...
public class IOFGui extends GuiScreen {
	...
	protected void actionPerformed(GuiButton p_146284_1_) {
		...
		case 0:
			...
			PacketHandler.INSTANCE.sendToServer(new PutMessage(Direction.TOP.toString(), tile.xCoord, tile.yCoord, tile.zCoord, id, topMode.toString()));
			break;
		case 1:
			...
			PacketHandler.INSTANCE.sendToServer(new PutMessage(Direction.FRONT.toString(), tile.xCoord, tile.yCoord, tile.zCoord, id, frontMode.toString()));
			break;
		case 2:
			...
			PacketHandler.INSTANCE.sendToServer(new PutMessage(Direction.LEFT.toString(), tile.xCoord, tile.yCoord, tile.zCoord, id, leftMode.toString()));
			break;
		case 3:
			...
			PacketHandler.INSTANCE.sendToServer(new PutMessage(Direction.RIGHT.toString(), tile.xCoord, tile.yCoord, tile.zCoord, id, rightMode.toString()));
			break;
		case 4:
			...
			PacketHandler.INSTANCE.sendToServer(new PutMessage(Direction.BOTTOM.toString(), tile.xCoord, tile.yCoord, tile.zCoord, id, bottomMode.toString()));
			break;
		case 5:
			...
			PacketHandler.INSTANCE.sendToServer(new PutMessage(Direction.BACK.toString(), tile.xCoord, tile.yCoord, tile.zCoord, id, backMode.toString()));
			break;
		}
	}
	...
	public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
		...
		mc.fontRenderer.drawString(id.equals("F") ? StatCollector.translateToLocal(pre + "fuel") : id.equals("I") ? StatCollector.translateToLocal(pre + "input") : StatCollector.translateToLocal(pre + "output"), guiLeft + 8, guiTop + 6, 4210752);
	...
	public void onGuiClosed() {
		...
		PacketHandler.INSTANCE.sendToServer(new OpenMessage(tile.xCoord, tile.yCoord, tile.zCoord, id));
	}
