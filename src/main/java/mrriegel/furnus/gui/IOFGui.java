...
public class IOFGui extends GuiScreen {
	...
	public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
		...
		mc.fontRendererObj.drawString(id.equals("F") ? StatCollector.translateToLocal(pre + "fuel") : id.equals("I") ? StatCollector.translateToLocal(pre + "input") : StatCollector.translateToLocal(pre + "output"), guiLeft + 8, guiTop + 6, 4210752);
