...
public class ExternalHeaterHandler {
	 ...
	 * 
	 *         An interface to be implemented by TileEntities that want to allow
	 *         direct interaction with the external heater
	 */
	public static interface IExternalHeatable {
		 ...
		 *            the amount of RF the furnace heater has stored and can
		 *            supply
		 * @param redstone
		 *            whether a redstone signal is applied to the furnace
		 *            heater. To keep the target warm, but not do speed
		 *            increases
		 * @return the amount of RF consumed that tick. Should be lower or equal
		 *         to "energyAvailable", obviously
		 */
	 ...
	 * @author BluSunrize - 09.12.2015
	 * 
	 *         An adapter to appyl to TileEntities that can't implement the
	 *         IExternalHeatable interface
	 */
